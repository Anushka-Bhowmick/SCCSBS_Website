const Events = () => {
  return (
    <div className="relative bg-midnightblue w-full h-[832px] overflow-hidden">
      <div className="absolute top-[calc(50%_-_414px)] right-[808px] rounded-[50%] bg-deeppink-200 [filter:blur(400px)] box-border w-[895px] h-[830px] border-[1px] border-solid border-black" />
      <section className="absolute top-[0px] left-[40px] w-[1068px] h-[818px] text-left text-base text-black font-jacques-francois">
        <div className="absolute top-[778px] left-[416px] rounded-131xl bg-skyblue-100 w-[167px] h-10" />
        <div className="absolute top-[778px] left-[196px] rounded-131xl bg-white w-[167px] h-10" />
        <div className="absolute top-[778px] left-[866px] rounded-131xl bg-gray-100 w-[167px] h-10" />
        <div className="absolute top-[778px] left-[639px] rounded-131xl bg-skyblue-100 w-[167px] h-10" />
        ...
        <div className="absolute top-[192px] left-[314px] text-29xl capitalize font-semibold font-h1-heading text-white">
        ...
        <div className="absolute top-[0px] left-[500.19px] text-45xl [text-decoration:underline] capitalize font-semibold font-h1-heading text-white inline-block w-[445.83px] h-[1.79px]">
          Events
        </div>
      </section>
    </div>
